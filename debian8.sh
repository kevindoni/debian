...
commonname=kevindonisaputra@gmail.com
email=kevindonisaputra@gmail.com
...
echo 'echo -e "Script Mod by Embex"' >> .bashrc
...
echo "Modified by Embex"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
